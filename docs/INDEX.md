...
| [builder](../builder/CONTRACT.md) | Plans, tool builds, story venues and casting at the story's hour, pinned to where the cast works | flow, story, world, ports | [requests](../builder/CONTRACT.md#in), [results](../builder/schema.ts) |
