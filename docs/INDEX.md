...
| [creation](../creation/CONTRACT.md) | Main/side orchestration; live or external authoring into a replayable recording and a bundle; replay, materialize and bundle CLIs | story, builder, world, ports, handoff | [creation](../creation/schema.ts), [quest set](../creation/schema/questline-set.schema.json), [recording](../creation/samples/RecordedPorts.ts), [author directory](../creation/CONTRACT.md#external-author), [item templates](../creation/samples/mission-item-templates.json), [scene templates](../creation/samples/SceneTemplates.ts) |
