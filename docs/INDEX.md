...
| [builder](../builder/CONTRACT.md) | Plans and tool builds over the playable step kinds, story venues and casting at the story's hour, pinned to where the cast works | flow, story, world, ports | [requests](../builder/CONTRACT.md#in), [results](../builder/schema.ts) |
